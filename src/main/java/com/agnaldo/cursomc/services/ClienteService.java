...
public class ClienteService {
	...
	//Para garantir que será inserido o Cliente com o Endereço de forma transasional (para garantir que serão salvo tanto o cliente quanto o endereço na mesma transação)
	@Transactional
