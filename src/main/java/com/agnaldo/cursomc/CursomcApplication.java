...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "maria@gmail.com", "09615461903", TipoCliente.PESSOAFISICA);
		cli1.getTelefones().addAll(Arrays.asList("35552871", "988913377"));
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "30220034", cli1, c1);
